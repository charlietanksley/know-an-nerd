...
/*!
  ...
  */
!function(e){e.ender({poke:function(t){return this.forEach(function(n){function a(e,t,n,r){var i=Math.abs(e-t),s=Math.abs(n-r);return i>=s?e-t>0?"W":"E":n-r>0?"N":"S"}var r=e(n),i,s={},o,u;r.bind(t).bind({touchstart:function(e){i=[],o="",u=e.touches.length-1,s.x1=e.touches[u].pageX,s.y1=e.touches[u].pageY},touchmove:function(e){s.x2=e.touches[u].pageX,s.y2=e.touches[u].pageY;if(Math.abs(s.x1-s.x2)>60||Math.abs(s.y1-s.y2)>60){var t=a(s.x1,s.x2,s.y1,s.y2);s.x1=s.x2,s.y1=s.y2;if(t==o)return;o=t,i.push(t)}},touchend:function(){if(!i.length)return;r.trigger(i.join("-"))}})})}},!0)}(ender),typeof provide=="function"&&provide("ender-poke",e.exports),$.ender(e.exports)}(),function(){var e={exports:{}},t=e.exports,n;n=typeof t!="undefined"&&t!==null?t:this.route={},n.Router=function(){function e(){this.routes=[]}return e.prototype.add=function(e,t){var n,r,i;typeof e=="object"?i=e:(i={},i[e]=t);for(e in i)t=i[e],r="^"+e+"$",r=r.replace(/([?=,\/])/g,"\\$1"),r=r.replace(/\[(.*?)\]/g,"[[$1]]"),n=["path"],r=r.replace(/(:|\*)([\w\d]+)/g,function(e,t,r){n.push(r);switch(t){case":":return"([^/]*)";case"*":return"(.*?)"}}),r=r.replace(/\[\[(.*?)\]\]/g,"(?:$1)?"),this.routes.push({expr:e,params:n,pattern:new RegExp(r),fn:t})},e.prototype.run=function(e,t,r){var i,s,o,u,a,f,l,c,h,p;u=[],p=this.routes;for(f=0,c=p.length;f<c;f++){n=p[f];if(o=n.pattern.exec(e)){i={};for(s=l=0,h=o.length;l<h;s=++l)a=o[s],i[n.params[s]]=decodeURIComponent(a);u.push(n.fn.call(t,i));if(r)return u[0]}}return u},e}(),typeof provide=="function"&&provide("route",e.exports),function(e){return e.ender({route:(new require("route")).Router})}(ender)}()