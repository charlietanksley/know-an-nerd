...
/*!
  ...
  */
!function(e){e.ender({poke:function(t){return this.forEach(function(n){function a(e,t,n,r){var i=Math.abs(e-t),s=Math.abs(n-r);return i>=s?e-t>0?"W":"E":n-r>0?"N":"S"}var r=e(n),i,s={},o,u;r.bind(t).bind({touchstart:function(e){i=[],o="",u=e.touches.length-1,s.x1=e.touches[u].pageX,s.y1=e.touches[u].pageY},touchmove:function(e){s.x2=e.touches[u].pageX,s.y2=e.touches[u].pageY;if(Math.abs(s.x1-s.x2)>60||Math.abs(s.y1-s.y2)>60){var t=a(s.x1,s.x2,s.y1,s.y2);s.x1=s.x2,s.y1=s.y2;if(t==o)return;o=t,i.push(t)}},touchend:function(){if(!i.length)return;r.trigger(i.join("-"))}})})}},!0)}(ender),typeof provide=="function"&&provide("ender-poke",e.exports),$.ender(e.exports)}()